insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('campoPrincesas', 'google.com', 'HISTORICO', 'História:
