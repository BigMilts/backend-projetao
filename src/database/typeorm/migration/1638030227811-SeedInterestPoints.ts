...
export class SeedInterestPoints1638030227811 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        Janeiro.','aviaoAntigo','https://i.imgur.com/dLHjETL.png',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2016/12/monumento-aviadores-2.jpg',24);
        ...
        monumento, construído por Abelardo da Hora.','zumbiDosPalmares','https://i.imgur.com/qz6dur1.png',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2016/12/est%C3%A1tua-de-zumbi-2.jpg',25);
        ...
        foi introjetado na memória das pessoas, exemplifica.','boiVoador','https://i.imgur.com/Jdsc1Nd.png',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2016/12/boi-voador-ok.jpg',26);
        ...
        Pessoa.','joaoPessoa','https://i.imgur.com/VDHWg1x.png',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2016/12/Rua-assassinato-Jo%C3%A3o-Pessoa.jpg',27);
        ...
        deixando cerca de 120 mortos.','jamesLancaster','https://i.imgur.com/dKTblBt.png',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2016/12/Captura-do-recife.jpg',28);
        ...
        proximidades do Forte das Cinco Pontas, no bairro de São José.','freiCaneca','https://i.imgur.com/enwKTeS.png',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2016/12/Colagem-frei-caneca.jpg',29);
        ...
        segunda metade do século 17.','igrejaNossaSenhoraRosario','https://i.imgur.com/yaiSMYL.png',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2016/12/Igreja-de-nossa-senhora-dos-homens-pretos.jpg',30);`);
        ...
        história: O forte, de pequenas proporções (estima-se que cerca de 6 metros em cada lado) também foi feito para proteger o Porto do Recife. Ele cruzava fogo com o Forte de São Jorge Novo para afastar com mais efetividade possíveis invasores.','fortePicao','https://i.imgur.com/K7VokD9.png',2,'FALSE','http://2.bp.blogspot.com/-e_ZNzzhTb_U/UvimnHuiY0I/AAAAAAAAArQ/GyTltypzMJ0/s1600/Forte+do+Pica%CC%83o.jpg',31);
        ...
        história: Inicialmente, o local foi criado pelo Governador de Pernambuco com a denominação Forte de São Francisco, mas com a ocupação holandesa foi reformado e passou por outra mudança em 1800. A última restauração do forte foi feita no século XX.','forteQueijo','https://i.imgur.com/fVHymSu.png',2,'FALSE','https://media-cdn.tripadvisor.com/media/photo-s/08/cf/8c/60/fortim-de-sao-francisco.jpg',32);
        ...
        posicionado estrategicamente para cercar os inimigos com mais facilidade','forteRealBomJesus','https://i.imgur.com/dXEvTsE.png',2,'FALSE','https://uploads.knightlab.com/storymapjs/d5cc53d28ab2db871c39e00a9bdd9e6c/fortes-de-pernambuco/_images/forte%20bom%20jesus%20.jpg',33);
        ...
        história: Foi uma das primeiras fortificações construídas no Recife quando os holandeses invadiram a área. Muitas emboscadas de luso-brasileiros foram feitas para evitar sua construção, sem sucesso.','forteBrum','https://i.imgur.com/pkGwn7E.png',2,'FALSE','https://media.sketchfab.com/models/1bf781cd040d424bb7941adcb9fc54f1/thumbnails/5da5400f56f942ab9313a8bd4a44f77f/a4d619a8280544b5a9c0fc1ae23f8ff1.jpeg',34);
        ...
        história: Fortificação foi construída em cima do Forte de São Jorge Velho quando os holandeses chegaram ao Brasil.','forteBuraco','https://i.imgur.com/D3gLrb1.png',2,'FALSE','https://jconlineimagem.ne10.uol.com.br/imagem/noticia/2016/04/17/normal/9f61f918b37df7aead4beb08c18b11e9.jpg',36);
        ...
        Situação: Em bom estado de conservação
        história: O forte foi construído pelos holandeses para defender as vilas de Itamaracá e Igarassu','forteOrange','https://i.imgur.com/MoZgmym.png',2,'FALSE','https://i.ytimg.com/vi/ckIB2NJNseA/maxresdefault.jpg',38);
        ...
        como ninfeas, vitórias-régias e lótus.','pracaCasaForte','https://i.imgur.com/h8FCJnQ.png',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2015/12/casa-forte.jpg',40);
        ...
        juazeiro, todas elas espécies vegetais da Caatinga.','pracaEuclidesCunha','https://i.imgur.com/gO5FlnB.png',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2015/12/euclidesCunha.jpg',41);
        ...
        e com as águas dos rios Capibaribe e Beberibe.','pracaRepublica','https://i.imgur.com/0ep1idG.png',2,'FALSE','https://www.feriasbrasil.com.br/fotosfb/802222889-XG.jpg',42);
        INSERT INTO "interest_point" (id,latitude,longitude,category,name,description,badge,"badgeUrl",likes,"isFavorite","imageUrl","itineraryOrderId") VALUES (47,-8.0598,-34.87804,'JARDINS','Jardins do Campo das Princesas','Nas suas cercanias jaziam, a oeste, os escombros do que outrora foi o  Palácio de Friburgo, sede do governo nassoviano durante as invasões holandesas.
        ...
        Em 1859  sofreu uma reforma para hospedar o imperador Dom Pedro II, a imperatriz Dona Teresa Cristina de Bourbon-Duas Sicílias e suas filhas, ocasião em que recebeu o nome de Campo das Princesas, inicialmente dado ao jardim, depois estendendo-se a denominação ao Palácio.','campoPrincesas','https://i.imgur.com/f7xfjlS.png',2,'FALSE','https://media-cdn.tripadvisor.com/media/photo-s/08/48/1b/13/palacio-do-campo-das.jpg',43);
        ...
        de linhas retas e ampliando a Ilha dos Amores. Manteve o mobiliário','pracaDerby','https://i.imgur.com/kR6PMN4.png',2,'FALSE','https://visit.recife.br/wp-content/uploads/2018/04/o-que-fazer-praca-do-derby-topo-mobile.jpg',44);
        ...
        por uma sucessão de curvas que se diluíam no terreno.','pracaSalgadoFilho','https://i.imgur.com/eno3xZl.png',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2015/12/salgadoFilho.jpg',45);
        ...
        Dois Irmãos, é um lugar público agradável para o convívio social.','pracaFariaNeves','https://i.imgur.com/W882zlF.png',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2015/12/fariasNeves.jpg',46);`);
