...
export class SeedInterestPoints1638030227811 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        INSERT INTO "interest_point" (id,latitude,longitude,category,name,description,badge,"badgeUrl",likes,"isFavorite","imageUrl","itineraryOrderId") VALUES (21,-8.01342,-34.85025,'MUSEUS','5) SACRÁRIO','A obra do século 18 pertence à Igreja da Madre de Deus. Foi recuperada em 2014, apàs ser furtada há 40 anos
        ...
        INSERT INTO "interest_point" (id,latitude,longitude,category,name,description,badge,"badgeUrl",likes,"isFavorite","imageUrl","itineraryOrderId") VALUES (22,-8.04451,-34.90174,'MUSEUS','4)PAINÉIS(séc. 18)','Feitos em adoração a Nossa Senhora dos Prazeres, em alusão a Batalha dos Guararapes.
        ...
        única mantida conservada desde as maxambombas.','tremAntigo','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOLKnRV9oXShszNiRrzTq09jmCBAA2xGICDA&usqp=CAU',2,'FALSE','http://curiosamente.diariodepernambuco.com.br/wp-content/uploads/2016/01/maxambombacapa.jpg',23);
        ...
        INSERT INTO "interest_point" (id,latitude,longitude,category,name,description,badge,"badgeUrl",likes,"isFavorite","imageUrl","itineraryOrderId") VALUES (47,-8.0598,-34.87804,'JARDINS','Jardins do Campo das Princesas','às margens do Rio Capibaribe, os jardins foram reformados pelo paisagista','campoPrincesas','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOLKnRV9oXShszNiRrzTq09jmCBAA2xGICDA&usqp=CAU',2,'FALSE','https://media-cdn.tripadvisor.com/media/photo-s/08/48/1b/13/palacio-do-campo-das.jpg',43);
        ...
        Obra
        Tarde no Recife','ponteMauricioNassau','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOLKnRV9oXShszNiRrzTq09jmCBAA2xGICDA&usqp=CAU',2,'FALSE','https://revista.algomais.com/wp-content/uploads/2020/02/ponte-mauricio-de-nassau-1.jpg',60);
        ...
        Obra
        Á cidade poeira','marcoZero','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOLKnRV9oXShszNiRrzTq09jmCBAA2xGICDA&usqp=CAU',2,'FALSE','https://lh3.googleusercontent.com/umsh/AFiHsUGYU17f6k1OKeaPWk0K8gVGD96pA4CX5dz7H-qf0I6DHpHeaMbddMHnGo7MdVQTXL_RN2uRRNur6KQPsmnagYp9zJQmPRrzLMSDJV1dgk-b9TW1OcOYbVnxhaXxbnnQ46htn-k-Hx2H_w=s16383',62);
