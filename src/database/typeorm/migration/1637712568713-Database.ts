...
export class Database1637712568713 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "interest_point" ADD CONSTRAINT "FK_ad050012b878d2cac0e89743bd7" FOREIGN KEY ("itineraryId") REFERENCES "itinerary"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "interest_point" DROP CONSTRAINT "FK_ad050012b878d2cac0e89743bd7"`);
