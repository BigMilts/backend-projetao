...
export class Database1637712568713 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "interest_point" ("id" SERIAL NOT NULL, "latitude" double precision NOT NULL, "longitude" double precision NOT NULL, "category" character varying NOT NULL, "name" character varying NOT NULL, "description" text NOT NULL, "badge" character varying, "badgeUrl" character varying NOT NULL, "likes" integer NOT NULL DEFAULT '2', "isFavorite" boolean NOT NULL DEFAULT false, "isUnlocked" boolean NOT NULL DEFAULT false, "imageUrl" character varying NOT NULL DEFAULT 'https://arcturusgroup.com.br/wp-content/uploads/2014/07/paisagem-marco-zero-recife.gif', "itineraryOrderId" integer, CONSTRAINT "REL_dca4bc5a907b738bec5b83322f" UNIQUE ("itineraryOrderId"), CONSTRAINT "PK_7c470e3cb613c12abc59bf2e3d7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "profile" ("id" SERIAL NOT NULL, "category" character varying NOT NULL, CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`);
