...
export class Seed1637712575151 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('campoPrincesas', 'google.com', 'HISTORICO', 'História:
        ...
        pelo Rio Capibaribe. ', 2, NULL, -8.06001, -34.8774, 'Palácio do Campo das Princesas');
        insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('cruzDoPatrao', 'google.com', 'FOLCLORE', 'À noite, o local é dominado por uma quietude solene e misteriosa, quebrada apenas pelo vento quando assovia sua canção tristonha. No Porto do Recife, às margens do Rio Beberibe, reina a Cruz do Patrão – lembrança concreta do passado imponente da capital pernambucana.
        ...
        Mesmo quase esquecida pela população, a coluna gigante jaz impávida, adornado com a sua beleza austera o cenário retilíneo e acinzentado do Porto do Recife. Se você sentir impulso de chegar mais perto, a recomendação é que o faça durante o dia, no máximo até o porto do sol, para ver como o crepúsculo pinta de tons belos e sinistros aquela região na cidade. Quando cai a penumbra, a Cruz do Patrão se torna domínio de todo tipo de fantasma e assombração. Pelo menos é o que ainda garantem alguns…melhor não arriscar, não é?', 1, NULL, -8.0472, -34.86995, 'Cruz do Patrão');
        insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('zumbiDosPalmares', 'google.com', 'HISTORICO', 'História: Um dos maiores símbolos da resistência escrava
        ...
        monumento, construído por Abelardo da Hora. ', 3, NULL, -8.06318, -34.8774, 'Cabeça do Zumbi de Palmares');
        insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('ponteMauricioNassau', 'google.com', 'HISTORICO', 'A
        ...
        Barbosa, pesquisadora da Fundação Joaquim Nabuco (Fundaj).  ', 4, NULL, -8.0639, -34.87531, 'Ponte Maurício de Nassau');
        insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('capturaRecife', 'google.com', 'HISTORICO', 'História:  Dois fatos precisam ser entendidos antes dos
        ...
        deixando cerca de 120 mortos. ', 5, NULL, -8.05391, -34.87098, 'Captura do Recife');
        insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('forte5pontas', 'google.coim', 'HISTORICO', 'História:  O líder libertário Joaquim do Amor Divino
        ...
        proximidades do Forte das Cinco Pontas, no bairro de São José.', 6, NULL, -8.07154, -34.8808, 'Forte das 5 Pontas');
        insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('igreja', 'google.com', 'HISTORICO', 'História: Trazidos à força do seu continente, com
        ...
        segunda metade do século 17. ', 8, NULL, -8.06539, -34.87787, 'Igreja de Nossa Senhora do Rosário dos Homens Pretos');
        insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('torreCristal', 'google.com', 'TURISTICO', 'O Parque de Esculturas Francisco Brennand foi inaugurado em 29 de dezembro 2000, idealizado pelo artista pernambucano Francisco Brennand, integrando o projeto “Eu vi o mundo… Ele Começava no Recife” para comemoração dos 500 anos do descobrimento do Brasil.
        ...
        Atualmente serve como ponto de encontro de jovens, desportistas, artistas, turistas e moradores da cidade. Além de ser palco de comemorações e apresentações artísticas.', 10, NULL, -8.06314, -34.87113, 'Marco Zero');
        insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('loiraSantoAmaro', 'google.com', 'FOLCLORE', 'O Cemitério de Santo Amaro foi inaugurado em 1851 por ordem de Francisco do Rêgo Barros, o Barrão da Boa Vista. Com o passar do tempo, os mais abastados também ocuparam espaço na necrópole. As famílias endinheiradas mandaram construir jazigos luxuosos, feitos de mármore, marcados com por epitáfios escritos com letras de bronze, decorados com estátuas em tamanho natural. A riqueza desses detalhes que transformou o local numa galeria de arte ao ar livre.
        ...
        Para alguns, as aparições só vão cessar quando o espírito da Galega for apaziguado: ela estaria à procura de um amante com quem pudesse dividir toda uma eternidade consumida em luxúrias infernais. Quem se candidata?', 11, NULL, -8.05032, -34.88279, 'Galega de Santo Amaro');
        insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('choraMenino', 'google.com', 'FOLCLORE', 'A Praça Chora Menino fica no bairro da Boa Vista, uma das áreas mais movimentadas  da capital pernambucana. Próxima ao Colégio Salesiano, à Praça do Derby e às ruas do Progresso e das Ninfas, é hoje uma simples confluência de vias, espaço atravessado às pressas  por gente desatenta, preocupada em chegar rápido ao seu destino. Poucos devem se perguntar por que o logradouro tem esse nome – que pode até soar poético. Menos pessoas ainda imaginam que o local foi cenário de uma tragédia e tem fama de mal assombrado.
        ...
        Os funcionários do museu dizem que até hoje o espírito da adolescente assombra a construção histórica. Nas noites caladas, Ana Lúcia caminha solenemente pelos corredores. A sua beleza  a princípio fascina e depois amedronta as testemunhas. E muitos servidores públicos – inclusive até alguns guardas municipais – pediram afastamento do trabalho do museu para não terem que se deparar com o fantasma da debutante.', 14, NULL, -8.05274, -34.87572, 'O Fantasma da Debutante');
        insert into "interest_point" ("badge", "badgeUrl", "category", "description", "id", "itineraryId", "latitude", "longitude", "name") values ('baraoPerseguido', 'google.com', 'FOLCLORE', 'No Século XIX, ficou conhecida no Recife a história de um Barão que teria feito um pacto com o Diabo. Não se sabe o que o fidalgo pediu ao “Coisa Ruim”, mas contava-se o Demônio o perseguia, possivelmente cobrando o pagamento que havia sido combinado.
        ...
        E quando o homem voltava desses encontros, “parecia que ia botar a alma pela boca”, pois “seu rosto era então o de um cadáver e suas mãos, também, as de um defunto”. Ainda de acordo com Freyre, tudo indica que o Diabo acabou ficando não só com alma, mas também com o corpo do Barão. Tanto que, para fingir enterrá-lo no Cemitério de Santo Amaro, o mais tradicional do Recife, “a família tivera que encher o caixão de pedra”.', 15, NULL, -8.05049, -34.88357, 'O Barão Perseguido pelo Diabo');
        ;
        `);

        await queryRunner.query(`INSERT INTO "profile" (id, description) VALUES (1, 'Historiador');
        INSERT INTO "profile" (id, description) VALUES (2, 'Folclorico');`);

        await queryRunner.query(`INSERT INTO "itinerary" (id, "profileId") VALUES (1, 1);
        INSERT INTO "itinerary" (id, "profileId") VALUES (2, 2);`);

        await queryRunner.query(`INSERT INTO "user" (id, email, password, name, "profilePicture", experience, historian, "profileId") VALUES (3, 'teste@email.com', 'senha123', null, null, 0, false, null);
        INSERT INTO "user" (id, email, password, name, "profilePicture", experience, historian, "profileId") VALUES (4, 'milton@email.com', 'senha123', 'José', 'milton.jpg', 0, false, null);`);
