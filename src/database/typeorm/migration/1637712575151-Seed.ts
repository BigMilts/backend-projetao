...
export class Seed1637712575151 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        INSERT INTO public.profile (id, description) VALUES (2, 'Folclorico');`);
...
INSERT INTO public.interest_point (id, latitude, longitude, category, name, description, badge, "badgeUrl", "itineraryId") VALUES (11, -8.05032, -34.88279, 'FOLCLORE', 'Galega de Santo Amaro', 'O Cemitério de Santo Amaro foi inaugurado em 1851 por ordem de Francisco do Rêgo Barros, o Barrão da Boa Vista. Com o passar do tempo, os mais abastados também ocuparam espaço na necrópole. As famílias endinheiradas mandaram construir jazigos luxuosos, feitos de mármore, marcados com por epitáfios escritos com letras de bronze, decorados com estátuas em tamanho natural. A riqueza desses detalhes que transformou o local numa galeria de arte ao ar livre.
...
INSERT INTO public.interest_point (id, latitude, longitude, category, name, description, badge, "badgeUrl", "itineraryId") VALUES (12, -8.06013, -34.89474, 'FOLCLORE', 'Praça Chora Menino', 'A Praça Chora Menino fica no bairro da Boa Vista, uma das áreas mais movimentadas  da capital pernambucana. Próxima ao Colégio Salesiano, à Praça do Derby e às ruas do Progresso e das Ninfas, é hoje uma simples confluência de vias, espaço atravessado às pressas  por gente desatenta, preocupada em chegar rápido ao seu destino. Poucos devem se perguntar por que o logradouro tem esse nome – que pode até soar poético. Menos pessoas ainda imaginam que o local foi cenário de uma tragédia e tem fama de mal assombrado.
...
INSERT INTO public.interest_point (id, latitude, longitude, category, name, description, badge, "badgeUrl", "itineraryId") VALUES (15, -8.05049, -34.88357, 'FOLCLORE', 'O Barão Perseguido pelo Diabo', 'No Século XIX, ficou conhecida no Recife a história de um Barão que teria feito um pacto com o Diabo. Não se sabe o que o fidalgo pediu ao “Coisa Ruim”, mas contava-se o Demônio o perseguia, possivelmente cobrando o pagamento que havia sido combinado.
...
INSERT INTO public.interest_point (id, latitude, longitude, category, name, description, badge, "badgeUrl", "itineraryId") VALUES (14, -8.05274, -34.87572, 'FOLCLORE', 'O Fantasma da Debutante', 'Num dos mais bonitos prédios da Rua da Aurora, no Centro do Recife, funciona hoje o Museu de Arte Moderna Aloísio Magalhães – o MAMAM. Porém, mais do que apenas resguardar a cultura e abrigar importantes exposições, o espaço também é cenário de uma tristonha aparição fantasmagórica,  a lembrança sobrenatural de uma história trágica, recriada aqui pelas lentes do fotógrafo Lucas Evaristo.
